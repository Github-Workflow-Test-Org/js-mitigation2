...
``npm install``   
This will install required node modules for this application.ssss
``node index.js``  
...
It's configured to run on port 8000, if you want to change please change the code on ``index.js`` accordingly.  ss
```  
app.listen(8000, () => {
